...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.width = width
        self.height = height
        # creating an 2d array in the size of the room with the amount of dirt as value
        self.room = {}
        for w in range(width):
            for h in range(height):
                self.room[(w, h)] = dirt_amount
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        self.room[(x, y)] = max(0, self.room[(x, y)] - capacity)
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        return list(self.room.values()).count(0)
    ...
    def is_position_in_room(self, pos):
        ...
        """
        return (math.floor(pos.get_x()), math.floor(pos.get_y())) in self.room
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        return Position(random.uniform(0, self.width - 1), \
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        x = math.floor(pos.get_x())
        y = math.floor(pos.get_y())
        if not self.is_position_furnished(Position(x, y)) and (x, y) in self.room:
            return True
        else:
            return False
    ...
    def get_num_tiles(self):
        ...
        """
        return len(self.room) - len(self.furniture_tiles)
        
    def get_random_position(self):
        """
        Returns: a Position object; a valid random position (inside the room and not in a furnished area).
        """
        new_pos = Position(random.randint(0, self.width - 1), \
                        random.randint(0, self.height - 1))
